...
//				var srcPts = goodMatches.Select(m => keypoints1[m.QueryIdx].Point).ToArray();
//				var dstPts = goodMatches.Select(m => keypoints2[m.TrainIdx].Point).ToArray();

//				// Tìm ma trận biến đổi (Chỉ chạy nếu có đủ điểm)
//				if (srcPts.Length >= 4)
//				{
//					using var mask = new Mat();
//					var homography = CvInvoke.FindHomography(srcPts, dstPts, HomographyMethod.Ransac, 5.0, mask);
...
//				CvInvoke.Resize(img, img, new System.Drawing.Size(0, 0), scale, scale);
//			}
//		}
//	}
//}